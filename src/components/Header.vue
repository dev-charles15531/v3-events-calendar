...
import ViewsSelector from "./ViewsSelector.vue";

type ComponentProps = Omit<
  CalendarProps,
  "events" | "sundayStartWeek" | "popoverElement"
> & {
  now: Date;
  showAddBtn: boolean;
      ...
      <div class="flex space-x-1.5 items-center">
        <div class="flex items-center gap-2">
          ...
          <ViewsSelector
            ...
            @viewChange="handleCalendarViewChange"
        ...
        <Menu as="div" class="relative ml-6 md:hidden">
          ...
          >
            ...
            >
              <div v-if="showAddBtn" class="py-1">
              ...
              <div class="py-1">
                ...
                <MenuItem v-slot="{ active }">
                  <span
                    @click="
                      handleCalendarViewChange(StatusEnum.WEEK_VIEW)
                    "
                    :class="[
                      active
                        ? 'bg-gray-100 text-gray-900 outline-none'
                ...
                <MenuItem v-slot="{ active }">
                  <span
                    @click="
                      handleCalendarViewChange(StatusEnum.MONTH_VIEW)
                    "
                    :class="[
                      active
                        ? 'bg-gray-100 text-gray-900 outline-none'
